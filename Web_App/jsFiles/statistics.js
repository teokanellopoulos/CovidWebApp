function getData() {
    ...
    //xwrizoume ta dedomena se pinakes twn 74 stoixeiwn opou kathe pinakas einai mia mera
    function sliceIntoChunks(arr, chunkSize) {
        ...
        //ara exoume enan pinaka pinakwn
        return res;
    }
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            //an den yparxei o pinakas dedomenwn na dhmiourghthei
            if(tab === null) {
                if(data.length === 0) {
                    ...
                    //taksinomhsh kata fthinousa seira
                ...
                //alliws tha diagrafei kai tha dhmiourghthei enas kainourgios
